...
import { PenTool, Video, Zap, ArrowUpRight, Layers, MousePointer2, Workflow, Bot, Instagram, Linkedin } from 'lucide-react';
...
export default function Portfolio() {
    ...
    const fetchProjects = async () => {
      try {
        const query = `*[_type == "project"] | order(_createdAt asc) {
          _id, title, shortDescription, role, slug, image
        }`;
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-zinc-100 font-sans selection:bg-blue-600 selection:text-white overflow-x-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <Link href="/skills/ia" className="md:col-span-1 block">
              ...
              >
                ...
                <div>
                  <h3 className="text-xl font-bold text-white mb-1">Artificial Intelligence</h3>
                  <p className="text-blue-200/70 text-xs">Integração de modelos de IA generativa.</p>
                </div>
              </SpotlightCard>
            </Link>
            ...
            <Link href="/skills/n8n" className="md:col-span-1 block">
              ...
              >
                ...
                <div>
                    ...
                    <p className="text-zinc-500 text-xs">Automação de fluxos complexos e produtividade.</p>
                </div>
              </SpotlightCard>
            </Link>
