      ...
      <main className="max-w-7xl mx-auto px-6 pt-40 pb-20 relative z-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <Link href="/skills/ia-n8n" className="md:col-span-1 block">
              ...
              >
                ...
                <div>
                  <h3 className="text-xl font-bold text-white mb-1">Inteligência Artificial</h3>
                  <p className="text-blue-200/70 text-xs">
                    Integração de modelos de IA para criatividade.
                  </p>
                </div>
              </SpotlightCard>
            </Link>
            ...
            <Link href="/skills/ia-n8n" className="md:col-span-1 block">
              <SpotlightCard className="rounded-3xl p-8 flex flex-col justify-between min-h-[250px] h-full">
                ...
                <div>
                    ...
                    <p className="text-zinc-500 text-xs">Fluxos automatizados de processos e dados.</p>
                </div>
              </SpotlightCard>
            </Link>
          </div>
        ...
        <section id="projects" className="mb-40 scroll-mt-28">
            <div className="flex items-center justify-between mb-12">
               ...
               <span className="font-mono text-xs text-zinc-600 uppercase hidden md:block">/// Sanity CMS</span>
            </div>
